    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          ...
          element-loading-background="rgba(10,10,10, 0.5)"
        >提交</el-button>
        <el-button @click="informationShow = false" type="info">取 消</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        areaId: [{ required: true, message: "请输入情报区域", trigger: "blur" }]
      }
    };
  },
  computed: {
  ...
  methods: {
    ...
    async remove(id) {
      let result = await axiosRest(
        "/bsInformation/deleteInformation",
        { id: id },
        "get"
      );
      if (result.ret == "200") {
